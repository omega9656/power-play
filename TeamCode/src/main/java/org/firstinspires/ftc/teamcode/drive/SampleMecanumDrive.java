...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(3.75, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.13062;
...
//        imu.initialize(parameters);
    ...
    // remove functionality for safety
    @Override
